...
var OTLPProtoExporterBrowserBase = /** @class */ (function (_super) {
    ...
    OTLPProtoExporterBrowserBase.prototype._getExportRequestProto = function (clientType) {
    ...
    OTLPProtoExporterBrowserBase.prototype.send = function (objects, onSuccess, onError) {
        ...
        var exportRequestType = this._getExportRequestProto(this.getServiceClientType());

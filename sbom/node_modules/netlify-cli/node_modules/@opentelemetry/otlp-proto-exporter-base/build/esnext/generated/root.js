        ...
        proto.common = (function () {
            ...
            common.v1 = (function () {
                ...
                v1.InstrumentationLibrary = (function () {
                     ...
                     * @instance
                     */
                    InstrumentationLibrary.prototype.name = null;
                    /**
                     ...
                     * @instance
                     */
                    InstrumentationLibrary.prototype.version = null;
                    /**
        ...
        proto.trace = (function () {
            ...
            trace.v1 = (function () {
                ...
                v1.InstrumentationLibrarySpans = (function () {
                     ...
                     * @instance
                     */
                    InstrumentationLibrarySpans.prototype.schemaUrl = null;
                    /**
            ...
            metrics.v1 = (function () {
                ...
                v1.ResourceMetrics = (function () {
                    ...
                    ResourceMetrics.encode = function encode(message, writer) {
                        ...
                        if (message.schemaUrl != null && Object.hasOwnProperty.call(message, "schemaUrl"))
                            writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.schemaUrl);
                        if (message.instrumentationLibraryMetrics != null && message.instrumentationLibraryMetrics.length)
                            for (var i = 0; i < message.instrumentationLibraryMetrics.length; ++i)
                                $root.opentelemetry.proto.metrics.v1.InstrumentationLibraryMetrics.encode(message.instrumentationLibraryMetrics[i], writer.uint32(/* id 1000, wireType 2 =*/ 8002).fork()).ldelim();
                        return writer;
                    };
                    /**
                    ...
                    ResourceMetrics.decode = function decode(reader, length) {
                        ...
                        while (reader.pos < end) {
                            ...
                            switch (tag >>> 3) {
                                ...
                                case 1000: {
                                    if (!(message.instrumentationLibraryMetrics && message.instrumentationLibraryMetrics.length))
                                        message.instrumentationLibraryMetrics = [];
                                    message.instrumentationLibraryMetrics.push($root.opentelemetry.proto.metrics.v1.InstrumentationLibraryMetrics.decode(reader, reader.uint32()));
                                    break;
                                }
                                case 3: {
                                    message.schemaUrl = reader.string();
                    ...
                    ResourceMetrics.verify = function verify(message) {
                        ...
                        if (message.instrumentationLibraryMetrics != null && message.hasOwnProperty("instrumentationLibraryMetrics")) {
                            if (!Array.isArray(message.instrumentationLibraryMetrics))
                                return "instrumentationLibraryMetrics: array expected";
                            for (var i = 0; i < message.instrumentationLibraryMetrics.length; ++i) {
                                var error = $root.opentelemetry.proto.metrics.v1.InstrumentationLibraryMetrics.verify(message.instrumentationLibraryMetrics[i]);
                                if (error)
                                    return "instrumentationLibraryMetrics." + error;
                            }
                        }
                        if (message.schemaUrl != null && message.hasOwnProperty("schemaUrl"))
                            if (!$util.isString(message.schemaUrl))
                    ...
                    ResourceMetrics.fromObject = function fromObject(object) {
                        ...
                        if (object.instrumentationLibraryMetrics) {
                            if (!Array.isArray(object.instrumentationLibraryMetrics))
                                throw TypeError(".opentelemetry.proto.metrics.v1.ResourceMetrics.instrumentationLibraryMetrics: array expected");
                            message.instrumentationLibraryMetrics = [];
                            for (var i = 0; i < object.instrumentationLibraryMetrics.length; ++i) {
                                if (typeof object.instrumentationLibraryMetrics[i] !== "object")
                                    throw TypeError(".opentelemetry.proto.metrics.v1.ResourceMetrics.instrumentationLibraryMetrics: object expected");
                                message.instrumentationLibraryMetrics[i] = $root.opentelemetry.proto.metrics.v1.InstrumentationLibraryMetrics.fromObject(object.instrumentationLibraryMetrics[i]);
                            }
                        }
                        if (object.schemaUrl != null)
                            message.schemaUrl = String(object.schemaUrl);
                    ...
                    ResourceMetrics.toObject = function toObject(message, options) {
                        ...
                        if (message.instrumentationLibraryMetrics && message.instrumentationLibraryMetrics.length) {
                            ...
                            for (var j = 0; j < message.instrumentationLibraryMetrics.length; ++j)
                                object.instrumentationLibraryMetrics[j] = $root.opentelemetry.proto.metrics.v1.InstrumentationLibraryMetrics.toObject(message.instrumentationLibraryMetrics[j], options);
                        }
                        return object;
                    };
                    /**
                ...
                v1.InstrumentationLibraryMetrics = (function () {
                     ...
                     * @instance
                     */
                    InstrumentationLibraryMetrics.prototype.schemaUrl = null;
                    /**
                     ...
                     * @returns {$protobuf.Writer} Writer
                     */
                    InstrumentationLibraryMetrics.encodeDelimited = function encodeDelimited(message, writer) {
                        return this.encode(message, writer).ldelim();
                    };
                    /**
                    ...
                    InstrumentationLibraryMetrics.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.opentelemetry.proto.metrics.v1.InstrumentationLibraryMetrics();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                                case 1: {
                    ...
                    InstrumentationLibraryMetrics.fromObject = function fromObject(object) {
                        if (object instanceof $root.opentelemetry.proto.metrics.v1.InstrumentationLibraryMetrics)
                            return object;
                        var message = new $root.opentelemetry.proto.metrics.v1.InstrumentationLibraryMetrics();
                        if (object.instrumentationLibrary != null) {
                            if (typeof object.instrumentationLibrary !== "object")
                                throw TypeError(".opentelemetry.proto.metrics.v1.InstrumentationLibraryMetrics.instrumentationLibrary: object expected");
                            message.instrumentationLibrary = $root.opentelemetry.proto.common.v1.InstrumentationLibrary.fromObject(object.instrumentationLibrary);
                        }
                        if (object.metrics) {
                            if (!Array.isArray(object.metrics))
                                throw TypeError(".opentelemetry.proto.metrics.v1.InstrumentationLibraryMetrics.metrics: array expected");
                            message.metrics = [];
                            for (var i = 0; i < object.metrics.length; ++i) {
                                if (typeof object.metrics[i] !== "object")
                                    throw TypeError(".opentelemetry.proto.metrics.v1.InstrumentationLibraryMetrics.metrics: object expected");
                                message.metrics[i] = $root.opentelemetry.proto.metrics.v1.Metric.fromObject(object.metrics[i]);
                            }
                        }
                        if (object.schemaUrl != null)
                    ...
                    /**
                     * Gets the default type url for InstrumentationLibraryMetrics
                     * @function getTypeUrl
                     * @memberof opentelemetry.proto.metrics.v1.InstrumentationLibraryMetrics
                     * @static
                     * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
                     * @returns {string} The default type url
                     */
                    InstrumentationLibraryMetrics.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                        if (typeUrlPrefix === undefined) {
                            typeUrlPrefix = "type.googleapis.com";
                        }
                        return typeUrlPrefix + "/opentelemetry.proto.metrics.v1.InstrumentationLibraryMetrics";
                    };

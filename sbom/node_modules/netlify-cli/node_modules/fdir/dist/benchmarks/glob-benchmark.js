...
async function benchmark() {
    const counts = new index_1.fdir()
        .glob("**.js")
        .onlyCounts()
        .crawl(".")
        .sync();
    await benny_1.default.suite(`Asynchronous (${counts.files} files, ${counts.dirs} folders)`, benny_1.default.add(`fdir ${package_json_1.default.version} async`, async () => {
        await new index_1.fdir()
            .glob("**.js")
            .crawl(".")
            .withPromise();
    }), benny_1.default.add("glob async", async () => {
        await new Promise((resolve) => {
            (0, glob_1.default)("**/**.js", { dot: true }, () => resolve(undefined));
        });
    ...
    await benny_1.default.suite(`Synchronous (${counts.files} files, ${counts.dirs} folders)`, benny_1.default.add(`fdir ${package_json_1.default.version} sync`, () => {
        ...
        glob_1.default.sync("**/**.js", { dot: true });

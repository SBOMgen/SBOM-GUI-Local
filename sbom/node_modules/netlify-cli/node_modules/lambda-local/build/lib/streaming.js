...
var StreamingBody = /** @class */ (function (_super) {
    __extends(StreamingBody, _super);
    function StreamingBody(resolve) {
        var _this = _super.call(this) || this;
        _this.resolve = resolve;
        _this.headersSent = false;
        return _this;
    }
    StreamingBody.prototype.sendHeader = function (metadata) {
        if (metadata === void 0) { metadata = {}; }
        var headers = __assign({}, metadata.headers);
        if (this.contentType) {
            headers["Content-Type"] = this.contentType;
        }
        this.resolve(__assign(__assign({}, metadata), { headers: headers, body: this }));
        this.headersSent = true;
    };
    StreamingBody.prototype.setContentType = function (contentType) {
        this.contentType = contentType;
    };
    return StreamingBody;
}(stream_1.PassThrough));
var HttpResponseStream = /** @class */ (function () {
    function HttpResponseStream() {
    }
    HttpResponseStream.from = function (responseStream, metadata) {
